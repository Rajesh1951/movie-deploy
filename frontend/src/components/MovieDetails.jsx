...
function MovieDetails() {
  ...
  return (
    <Box bg='#1a202c' color='#cbd5e0' minH='89vh'>
      <Box w={['90vw', '80vw']} m='auto auto' >
        <HStack minH='60vh' >
          ...
          >
            <Heading>{data.original_title}({data.release_date.slice(0, 4)})</Heading>
            <Text fontSize='lg' as='b'>Overview</Text>
            <Text>{data.overview}</Text>
            <Text as='b'>User Score :<Text display='inline' fontSize='md' color='white'>{Math.floor(data.vote_average * 10)}%</Text></Text>
            <HStack>
              <Text as='b' display={'inline'}>Budget :</Text>
            ...
            <HStack>
              <Text as='b' display={'inline'}>Wesite :</Text>
